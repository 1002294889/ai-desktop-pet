export function createCompanionConversationPolicy(): string {
  return [
    ...
    'A follow-up is often useful when the user shares an event, achievement, problem, plan, emotional experience, person, work story, competition, trip, or relationship situation. It is optional unless a later current-turn reply-plan requirement explicitly requires it.',
